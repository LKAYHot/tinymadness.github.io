...
function getLocalizedString(key, lang) {
    var localizedStrings = {
        'ru': {
            ...
            'about_info': 'TinyMadness — это сообщество энтузиастов-переводчиков, создающее качественные русскоязычные локализации инди-игр. Наша цель — сделать игры доступными для широкой аудитории, сохраняя атмосферу и стиль оригинального проекта. Присоединяйтесь к нам в Discord или Telegram, чтобы не пропустить новости и принять участие в работе над переводами!',
            'about_title': 'О нас',
        ...
        'en': {
            ...
            'about_info': 'TinyMadness is a community of translation enthusiasts creating high-quality Russian localizations of indie games. Our goal is to make games accessible to a wide audience while preserving the atmosphere and style of the original project. Join us on Discord or Telegram to stay up to date with news and take part in our translation work!',
            'closing_title': 'TinyMadness',
