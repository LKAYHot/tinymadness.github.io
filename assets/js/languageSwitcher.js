...
function getLocalizedString(key, lang) {
    var localizedStrings = {
        'ru': {
            ...
            'games_Hell_trans_desc': 'Пройдите через глубины Ада и одолейте его самых могучих демонов на пути к Раю в этой игре в жанре horde-survival с элементами сбора колоды, вдохновленной „Божественной комедией“ Данте',
        ...
        'en': {
            ...
            'games_Hell_trans_desc': "Traverse the depths of Hell and beat its toughest demons on your way to Heaven in this horde survival deck-building game inspired by Dante`s Divine Comedy",
